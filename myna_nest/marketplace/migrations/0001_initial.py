# Generated by Django 3.0.3 on 2020-05-02 20:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='marketplace.StandardProduct', verbose_name='Product name')),
            ],
        ),
    ]
