...
class chatFirestoreClient {
  ...
  chatFirestoreClient(this._chatFirestoreCollection, this._userFirestoreCollection);
  ...
  Future<bool> addChatRoom(chatRoom, chatRoomId) {
    _chatFirestoreCollection.document(chatRoomId).setData(chatRoom).catchError((e) {
      print(e.toString());
    });
  }
